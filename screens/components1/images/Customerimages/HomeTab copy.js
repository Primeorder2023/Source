...
import { Text, View,Dimensions, FlatList,ActivityIndicator, Modal,TextInput,StyleSheet, Button, AppRegistry, ScrollView, Linking, Alert, TouchableOpacity, Image } from 'react-native';
...
class HomeTab extends Component {
  ...
  //  this.state.type= await AsyncStorage.getItem('type')
    ...
    this.getuser();
    console.log("rewardssss********",rewards,this.props);
    ...
    <View style={styles.flatliststyle1}>  
      ...
      <View style={{ flexDirection: "row",justifyContent:'space-evenly',alignItems:'center', backgroundColor:'#ffffff',width:width-10,alignSelf:'center' ,height:40}} >
           <Card style={{ height: screenwidth, width: screenwidth, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:2 }}>
              <TouchableOpacity onPress={() => {commonData.setContext("OG"); this.props.navigation.navigate('OrderGuide',{ From: '',TYPE:"PREBOOKINGS"  }) }}>
...
>
    ...
    <Image transition={false} source={require('./images/logout.png')} style={{ height: 20, width: 20 }}></Image>
               ...
               <Text style={{fontFamily:"Lato-Regular",fontSize:10,alignSelf:'center'}}>{commonData.getrewardPoints()}</Text>
                     </TouchableOpacity>
</View>
        ...
        <View style={{marginTop:0,height:screenheight/2+2,flexDirection:'column',backgroundColor:'#ffffff',alignSelf:'center',width:width-20,alignSelf:'center',alignItems:'center'
               ...
               <View style={styles.recoredbuttonStyle}>
                ...
                <TouchableOpacity onPress={() => {commonData.setContext("OG"); this.props.navigation.navigate('customer',{ From: 'OG',TYPE:"OG"  }) }}>                
            ...
            <View style={{ flexDirection: 'row', backgroundColor: '#FFFFFF',alignSelf:'center' ,marginTop:0}}>
              ...
              <Text style={{color:'white',width:20,height:20,alignSelf:'center',textAlign:'center',fontSize:8,fontFamily:'Lato-Regular',textAlign:'center',textAlignVertical:'center'}}>{Number(commonData.getpendingcount())<100?commonData.getpendingcount():"100+"}</Text>
          </View>
              ...
              <View style={styles.recoredbuttonStyle}>
              <View style={{backgroundColor:"#c94c4c",width:20,height:20,borderRadius:10,marginHorizontal:(screenwidth-25),marginTop:-32,alignitems:"center",alignContent:'center',justifyContent:'center'}}>
              <Text style={{color:'white',width:20,height:20,textAlign:'center',fontSize:8,fontFamily:'Lato-Regular',textAlign:'center',textAlignVertical:'center'}}>{Number(commonData.getorderscount())<100?commonData.getorderscount():"100+"}</Text>
              </View>
         ...
         <View style={styles.recoredbuttonStyle}>
         <View style={{backgroundColor:"#c94c4c",width:20,height:20,borderRadius:10,marginHorizontal:(screenwidth-25),marginTop:-32,alignitems:"center",alignContent:'center',justifyContent:'center'}}>
              <Text style={{color:'white',width:20,height:20,textAlign:'center',fontSize:8,fontFamily:'Lato-Regular',textAlign:'center',textAlignVertical:'center'}}>{Number(commonData.getoffercount())<100?commonData.getoffercount():"100+"}</Text>
          </View>
         <TouchableOpacity   onPress={() =>{ this.props.navigation.navigate('Offers') }}>
          ...
          <View style={{ backgroundColor: '#ffffff', marginTop:-30, height: 200, alignSelf:'center',width:screenheight,alignitems:'center'}}>
            ...
            <Card style={{ height: 180, width:width-30, backgroundColor: 'white',alignSelf:'center',justifyContent:'center',borderRadius:20}}>
              <Text style={{alignSelf:'center',justifyContent:'center',textAlign:'center',marginTop:10,fontFamily:'Lato-Bold',fontSize:20,fontWeight:'700'}}>{commonData.getActiveCustName()}</Text>
