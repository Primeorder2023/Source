...
import Map from "./Map";
 class Orderwisereport extends Component {
  ...
  credit:0,
   ...
   var sales_result = this.props.navigation.getParam("sales","");
  ...
  SignItemsView = ({ item, index }) => (
    ...
    getSalesDetails=()=>{
      ...
      var raw = JSON.stringify({
        "__initiated_by__": commonData.getusername()
      });
...
var raw = JSON.stringify({"__module_code__":"PO_15","__session_id__":commonData.getsessionId(),"__query__":"","__order_by__":"valid_to DESC"});
var requestOptions = {
  method: 'POST',
  headers: myHeaders,
  body: raw,
    ...
    return (
      ...
      <View style={{ backgroundColor: 'white' ,height:height-50}}>
        ...
        <View style={{marginTop:0,height:screenheight/2+2,flexDirection:'column',backgroundColor:'#ffffff',alignSelf:'center',width:width-20,alignSelf:'center',alignItems:'center'
          ...
          <View style={{flex:0.2, backgroundColor:'white', width:10,height:60, borderRadius:4, 
            shadowColor: '#000',
          ...
          borderRadius:15 }}>
                 ...
                 <Text style  ={{fontFamily:"Lato-Bold",height:30,textAlignVertical:'center',fontSize:15,color:'#011A90',textAlignVertical:'center',width:10, alignSelf:'center',textAlign:'left'}}>{this.state.pendingdeliveries}</Text>
          ...
          borderRadius:15 }}>
                 ...
                 <Text style  ={{fontFamily:"Lato-Bold",height:30,textAlignVertical:'center',fontSize:15,color:'#011A90',textAlignVertical:'center',width:10, alignSelf:'center',textAlign:'left'}}>{commonData.getpendingcount()}</Text>
          ...
          borderRadius:15 }}>
                 ...
                 <Text style  ={{fontFamily:"Lato-Bold",height:30,textAlignVertical:'center',fontSize:15,color:'#011A90',textAlignVertical:'center',width:10, alignSelf:'center',textAlign:'left'}}>{this.state.completeddeliveries}</Text>
          ...
          borderRadius:15 }}>
                 ...
                 <Text style  ={{fontFamily:"Lato-Bold",height:30,textAlignVertical:'center',fontSize:15,color:'#011A90',textAlignVertical:'center',width:10, alignSelf:'center',textAlign:'left'}}>{this.state.ontransit}</Text>
...
borderRadius:15 }}>
       ...
       <Text style  ={{fontFamily:"Lato-Bold",height:30,textAlignVertical:'center',fontSize:15,color:'#011A90',textAlignVertical:'center',width:10, alignSelf:'center',textAlign:'left'}}>{this.state.credit}</Text>
