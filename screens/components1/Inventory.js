...
var inventorypath = RNFS.DocumentDirectoryPath + '/inventorywareOffline.json';
...
searchFilterFunction = (text) => { 
    ...
    render() {
      ...
      const scrollEnabled=this.state.screenheight>height;
        ...
        containerStyle={{width:(width-40)/2-20
        }}
      ...
      <TouchableOpacity style={{backgroundColor:'#011A90',width:width-250,alignSelf:"center",marginTop:20,height:30}} onPress={()=>this.loadInventoryItems()}><Text style={{backgroundColor:'#011A90',color:'white',textAlign:'center',width:width-250,textAlignVertical:'center',alignSelf:"center",height:30}}>Apply Filter</Text></TouchableOpacity>
                  </View>
                  </View>
              </View>
          );
        ...
        <TouchableOpacity style={{borderRadius:20, height:60,width:width/3-10, justifyContent:'center', alignItems:'center' }} onPress={()=>this.props.navigation.goBack()}>           
            ...
            <Text style={{ marginTop:10, color: '#011A90',backgroundColor:' #FFFFFF',width:width/3+70, height: 50,fontFamily:'Lato-Regular' ,fontWeight:'bold',fontSize:17,alignSelf:'center',textAlign:"center",justifyContent:'center'}}>{Title}</Text>
...
elevation: 4 }} onPress={() => this.searchFilterFunction('')}>
              ...
              <Text style={styles.textSign}>Clear</Text>
               ...
               <Dropdown
        label='Choose Warehouse'
        containerStyle={{width:(width-40)/2-10, marginHorizontal:-20
        }}
        onChangeText={value=>this.changewarehouse(value)}
        value={this.state.warehouse}
        data={warehouselist}        
    ...
    sampleRenderItem = ({ item, index }) => (
      ...
      <ImageBackground source={require('./images/itembg.png')} style={styles.flatrecord}>
        ...
        <Text style={{color:'#000000',borderBottomColor:'#000000',fontWeight:'100',textAlign:'center',fontFamily:'Lato-Bold',width:60}}>₹{Number(item.price)}</Text>
